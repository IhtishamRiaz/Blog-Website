    ...
    return (
        <>
            <Box className='about-page page'>
                ...
                <Box className='sec-3-main'>
                    <Box className='sec-3-img'>
                        <img className='img' src={img} alt='' />
                    </Box>
                    <Box className='sec-3-para'>
                ...
                <Box className='sec-4-container2'>
                    <Box className='card'>
                ...
                <Box className='Sec-5'>
                    ...
                    <Box className='main-container-5'>
                        <Box className='input-main'>
                            <Box className='inputfield'>
                                <Box className='inputfield-2'>
                                    <AddIcon />
